...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-white dark:bg-slate-900 flex items-center justify-between px-8 py-4 z-10">
      <Link href="/">
        <Image src="/logo.svg" alt="Logo" width={130} height={130} className="md:w-[130px] w-[100px] dark:brightness-0 dark:invert" />
      </Link>
      ...
      <div className="flex items-center space-x-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="bg-slate-50 dark:bg-slate-800 shadow-none">
            ...
            <DropdownMenuItem asChild>
              <Link href="/principles" className="w-full">
                Principles
              </Link>
            </DropdownMenuItem>
          </DropdownMenuContent>
