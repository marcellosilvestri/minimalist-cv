          ...
          <div className="space-y-3" id="about-me">
            <div className="space-y-3" id="about-me">
              <p className="text-slate-500 dark:text-slate-400">
                I am a dedicated, T-shaped developer with a long story in the IT industry. I’ve worked with international organisations and currently support
                businesses in Europe, US and Asia. Passionate about traveling, I am fluent in English, Italian, and conversational in Japanese.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4" id="work-experience">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row gap-2 md:gap-0">
              ...
              <div className="md:w-4/5 space-y-2">
                <div className="flex items-center gap-3">
                  <Image src="/logos/kritic.svg" width={35} height={35} className="h-[35px] w-[35px]" alt="Kritic logo" />
                  <div>
